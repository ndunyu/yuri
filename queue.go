...
type Queue struct {
	...
	Workers int
	//Capacity many items will be held in the queue at a time before blocking
...
//The JobCallBack Process method specifies what should happen to each payload received by each worker
